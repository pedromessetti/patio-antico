...
* ### useNavigate
Hook do React Router DOM que nos proporciona navegar entre páginas da nossa aplicação e até mesmo voltar em páginas recém visitadas
...
* ## ESLint
Padronização do código com a ferramenta ESLint
# Autor
